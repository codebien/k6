k6 v0.31.0 is here! :tada: It's a smaller release with some performance improvements, a new `http_req_failed` metric and changes to the output subsystem that enables output extensions with xk6!
